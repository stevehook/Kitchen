...
1. Start adding the stock to the risotto one to two ladle fulls at a time, stirring and waiting for the rice to absorb the liquid before adding the next ladle. The rice takes about 20 minutes to cook.
...
RecipePhoto.create!(:recipe => risotto_recipe, :title => 'risotto', :image => File.open('db/pictures/risotto1.jpg'))
RecipePhoto.create!(:recipe => risotto_recipe, :title => 'risotto', :image => File.open('db/pictures/risotto2.jpg'))
RecipePhoto.create!(:recipe => risotto_recipe, :title => 'risotto', :image => File.open('db/pictures/risotto3.jpg'))
